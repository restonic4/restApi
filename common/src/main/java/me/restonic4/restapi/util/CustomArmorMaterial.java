...
import me.restonic4.restapi.util.UtilVersions.CustomArmorMaterial.CustomArmorMaterialSet3;
import net.minecraft.sounds.SoundEvent;
import net.minecraft.world.item.crafting.Ingredient;

import java.util.function.Supplier;

public class CustomArmorMaterial extends CustomArmorMaterialSet3 {
