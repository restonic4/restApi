...
public class CustomToolTierSet2 implements Tier {
    ...
    public CustomToolTierSet2(int uses, float speed, float attackDamageBonus, int level, int enchantmentValue, Object repairIngredient) {
        this.uses = uses;
        this.speed = speed;
