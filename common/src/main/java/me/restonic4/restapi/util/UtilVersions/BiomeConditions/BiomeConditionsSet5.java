...
public class BiomeConditionsSet5 {
    ...
    public BiomeConditionsSet5 isNether() {
    ...
    public BiomeConditionsSet5 isEnd() {
    ...
    //Biomes
    public BiomeConditionsSet5 isDeepOcean() {
    ...
    public BiomeConditionsSet5 isOcean() {
    ...
    public BiomeConditionsSet5 isBeach() {
    ...
    public BiomeConditionsSet5 isRiver() {
    ...
    public BiomeConditionsSet5 isMountain() {
    ...
    public BiomeConditionsSet5 isBadlands() {
    ...
    public BiomeConditionsSet5 isHill() {
    ...
    public BiomeConditionsSet5 isTaiga() {
    ...
    public BiomeConditionsSet5 isJungle() {
    ...
    public BiomeConditionsSet5 isForest() {
    ...
    public BiomeConditionsSet5 isSavanna() {
    ...
    //Structures
    public BiomeConditionsSet5 strongholdBiasedTo() {
    ...
    public BiomeConditionsSet5 hasBuriedTreasure() {
    ...
    public BiomeConditionsSet5 hasDesertPyramid() {
    ...
    public BiomeConditionsSet5 hasIgloo() {
    ...
    public BiomeConditionsSet5 hasJungleTemple() {
    ...
    public BiomeConditionsSet5 hasMineshaft() {
    ...
    public BiomeConditionsSet5 hasMineshaftMesa() {
    ...
    public BiomeConditionsSet5 hasOceanMonument() {
    ...
    public BiomeConditionsSet5 hasOceanRuinCold() {
    ...
    public BiomeConditionsSet5 hasOceanRuinWarm() {
    ...
    public BiomeConditionsSet5 hasPillagerOutpost() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalDesert() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalJungle() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalOcean() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalSwamp() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalMountain() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalStandard() {
    ...
    public BiomeConditionsSet5 hasShipwreckBeached() {
    ...
    public BiomeConditionsSet5 hasShipwreck() {
    ...
    public BiomeConditionsSet5 hasStronghold() {
    ...
    public BiomeConditionsSet5 hasSwampHut() {
    ...
    public BiomeConditionsSet5 hasVillageDesert() {
    ...
    public BiomeConditionsSet5 hasVillagePlains() {
    ...
    public BiomeConditionsSet5 hasVillageSavanna() {
    ...
    public BiomeConditionsSet5 hasVillageSnowy() {
    ...
    public BiomeConditionsSet5 hasVillageTaiga() {
    ...
    public BiomeConditionsSet5 hasTrailRuins() {
    ...
    public BiomeConditionsSet5 hasWoodlandMansion() {
    ...
    public BiomeConditionsSet5 hasNetherFortress() {
    ...
    public BiomeConditionsSet5 hasNetherFossil() {
    ...
    public BiomeConditionsSet5 hasBastionRemnant() {
    ...
    public BiomeConditionsSet5 hasAncientCity() {
    ...
    public BiomeConditionsSet5 hasRuinedPortalNether() {
    ...
    public BiomeConditionsSet5 hasEndCity() {
    ...
    public BiomeConditionsSet5 requiredOceanMonumentSurrounding() {
    ...
    public BiomeConditionsSet5 mineshaftBlocking() {
    ...
    //Other
    public BiomeConditionsSet5 playsUnderwaterMusic() {
    ...
    public BiomeConditionsSet5 hasCloserWaterFog() {
    ...
    public BiomeConditionsSet5 waterOnMapOutlines() {
    ...
    public BiomeConditionsSet5 producesCoralsFromBonemeal() {
    ...
    public BiomeConditionsSet5 increasedFireBurnout() {
    ...
    public BiomeConditionsSet5 snowGolemMelts() {
    ...
    public BiomeConditionsSet5 withoutZombieSieges() {
    ...
    public BiomeConditionsSet5 withoutPatrolSpawns() {
    ...
    public BiomeConditionsSet5 withoutWanderingTraderSpawns() {
    ...
    public BiomeConditionsSet5 spawnsColdVariantFrogs() {
    ...
    public BiomeConditionsSet5 spawnsWarmVariantFrogs() {
    ...
    public BiomeConditionsSet5 spawnsGoldRabbits() {
    ...
    public BiomeConditionsSet5 spawnsWhiteRabbits() {
    ...
    public BiomeConditionsSet5 reducedWaterAmbientSpawns() {
    ...
    public BiomeConditionsSet5 allowsTropicalFishSpawnsAtAnyHeight() {
    ...
    public BiomeConditionsSet5 polarBearsSpawnOnAlternateBlocks() {
    ...
    public BiomeConditionsSet5 moreFrequentDrownedSpawns() {
    ...
    public BiomeConditionsSet5 allowsSurfaceSlimeSpawns() {
    ...
    public BiomeConditionsSet5 spawnsSnowFoxes() {
    ...
    //Custom
    public BiomeConditionsSet5 addCustomBiomeTagKey(TagKey<Biome> tagKey) {
