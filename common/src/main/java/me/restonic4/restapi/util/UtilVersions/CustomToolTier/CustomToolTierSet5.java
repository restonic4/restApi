...
public class CustomToolTierSet5 implements Tier {
    ...
    public CustomToolTierSet5(int uses, float speed, float attackDamageBonus, int level, int enchantmentValue, Object repairIngredient) {
