...
public class BiomeConditionsSet3 {
    ...
    public BiomeConditionsSet3 isNether() {
    ...
    public BiomeConditionsSet3 isEnd() {
    ...
    //Biomes
    public BiomeConditionsSet3 isDeepOcean() {
    ...
    public BiomeConditionsSet3 isOcean() {
    ...
    public BiomeConditionsSet3 isBeach() {
    ...
    public BiomeConditionsSet3 isRiver() {
    ...
    public BiomeConditionsSet3 isMountain() {
    ...
    public BiomeConditionsSet3 isBadlands() {
    ...
    public BiomeConditionsSet3 isHill() {
    ...
    public BiomeConditionsSet3 isTaiga() {
    ...
    public BiomeConditionsSet3 isJungle() {
    ...
    public BiomeConditionsSet3 isForest() {
    ...
    public BiomeConditionsSet3 isSavanna() {
    ...
    //Structures
    public BiomeConditionsSet3 strongholdBiasedTo() {
    ...
    public BiomeConditionsSet3 hasBuriedTreasure() {
    ...
    public BiomeConditionsSet3 hasDesertPyramid() {
    ...
    public BiomeConditionsSet3 hasIgloo() {
    ...
    public BiomeConditionsSet3 hasJungleTemple() {
    ...
    public BiomeConditionsSet3 hasMineshaft() {
    ...
    public BiomeConditionsSet3 hasMineshaftMesa() {
    ...
    public BiomeConditionsSet3 hasOceanMonument() {
    ...
    public BiomeConditionsSet3 hasOceanRuinCold() {
    ...
    public BiomeConditionsSet3 hasOceanRuinWarm() {
    ...
    public BiomeConditionsSet3 hasPillagerOutpost() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalDesert() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalJungle() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalOcean() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalSwamp() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalMountain() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalStandard() {
    ...
    public BiomeConditionsSet3 hasShipwreckBeached() {
    ...
    public BiomeConditionsSet3 hasShipwreck() {
    ...
    public BiomeConditionsSet3 hasStronghold() {
    ...
    public BiomeConditionsSet3 hasSwampHut() {
    ...
    public BiomeConditionsSet3 hasVillageDesert() {
    ...
    public BiomeConditionsSet3 hasVillagePlains() {
    ...
    public BiomeConditionsSet3 hasVillageSavanna() {
    ...
    public BiomeConditionsSet3 hasVillageSnowy() {
    ...
    public BiomeConditionsSet3 hasVillageTaiga() {
    ...
    public BiomeConditionsSet3 hasTrailRuins() {
    ...
    public BiomeConditionsSet3 hasWoodlandMansion() {
    ...
    public BiomeConditionsSet3 hasNetherFortress() {
    ...
    public BiomeConditionsSet3 hasNetherFossil() {
    ...
    public BiomeConditionsSet3 hasBastionRemnant() {
    ...
    public BiomeConditionsSet3 hasAncientCity() {
    ...
    public BiomeConditionsSet3 hasRuinedPortalNether() {
    ...
    public BiomeConditionsSet3 hasEndCity() {
    ...
    public BiomeConditionsSet3 requiredOceanMonumentSurrounding() {
    ...
    public BiomeConditionsSet3 mineshaftBlocking() {
    ...
    //Other
    public BiomeConditionsSet3 playsUnderwaterMusic() {
    ...
    public BiomeConditionsSet3 hasCloserWaterFog() {
    ...
    public BiomeConditionsSet3 waterOnMapOutlines() {
    ...
    public BiomeConditionsSet3 producesCoralsFromBonemeal() {
    ...
    public BiomeConditionsSet3 increasedFireBurnout() {
    ...
    public BiomeConditionsSet3 snowGolemMelts() {
    ...
    public BiomeConditionsSet3 withoutZombieSieges() {
    ...
    public BiomeConditionsSet3 withoutPatrolSpawns() {
    ...
    public BiomeConditionsSet3 withoutWanderingTraderSpawns() {
    ...
    public BiomeConditionsSet3 spawnsColdVariantFrogs() {
    ...
    public BiomeConditionsSet3 spawnsWarmVariantFrogs() {
    ...
    public BiomeConditionsSet3 spawnsGoldRabbits() {
    ...
    public BiomeConditionsSet3 spawnsWhiteRabbits() {
    ...
    public BiomeConditionsSet3 reducedWaterAmbientSpawns() {
    ...
    public BiomeConditionsSet3 allowsTropicalFishSpawnsAtAnyHeight() {
    ...
    public BiomeConditionsSet3 polarBearsSpawnOnAlternateBlocks() {
    ...
    public BiomeConditionsSet3 moreFrequentDrownedSpawns() {
    ...
    public BiomeConditionsSet3 allowsSurfaceSlimeSpawns() {
    ...
    public BiomeConditionsSet3 spawnsSnowFoxes() {
